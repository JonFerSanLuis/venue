                                    ...
                                    <td class="px-6 py-4 text-center">
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <form action="{{ route('festivals.destroy', $festival->id) }}" method="POST" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="inline-flex items-center px-3 py-1.5 border border-transparent shadow-sm text-xs font-medium rounded text-red-700 bg-red-50 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500" onclick="return confirm('¿Seguro que quieres borrar este festival?')">
                                                    Eliminar
                                                </button>
                                            </form>
                                        </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <p class="text-sm text-gray-500">Empieza registrando tu primer festival en el sistema.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
                    ...
                    <table class="w-full whitespace-nowrap text-left text-sm text-gray-600">
                        ...
                        <tbody class="divide-y divide-gray-100">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <p class="text-sm text-gray-500">No hay artistas registrados todavía.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
