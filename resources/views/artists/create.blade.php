                ...
                <form action="{{ route('artists.store') }}" method="POST" enctype="multipart/form-data" class="p-8 space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="genre" class="w-full border-gray-300 py-3 px-4 rounded-sm text-sm focus:ring-gray-900 focus:border-gray-900" placeholder="Ej: Techno, Trap, Rock">
                        </div>
                        <div>
                            <label class="block text-xs font-bold uppercase text-gray-600 mb-2">País de Origen</label>
                            <input type="text" name="country" class="w-full border-gray-300 py-3 px-4 rounded-sm text-sm focus:ring-gray-900 focus:border-gray-900" placeholder="Ej: España, Colombia, USA">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-xs font-bold uppercase text-gray-600 mb-2">Biografía</label>
                            <textarea name="bio" rows="4" class="w-full border-gray-300 py-3 px-4 rounded-sm text-sm focus:ring-gray-900 focus:border-gray-900" placeholder="Breve descripción del artista, trayectoria, estilo..."></textarea>
                        </div>
                        <div class="md:col-span-2">
                    ...
                    <div class="border-t border-gray-100 pt-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="url" name="spotify_url" class="w-full border-gray-300 py-3 px-4 rounded-sm text-sm focus:ring-gray-900 focus:border-gray-900" placeholder="https://open.spotify.com/artist/...">
                            ...
                            <div>
                                ...
                                <input type="url" name="youtube_url" class="w-full border-gray-300 py-3 px-4 rounded-sm text-sm focus:ring-gray-900 focus:border-gray-900" placeholder="https://www.youtube.com/watch?v=...">
